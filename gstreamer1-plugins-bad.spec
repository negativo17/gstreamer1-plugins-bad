...
BuildRequires:  pkgconfig(mpeghdec) >= 3.0.2
...
#BuildRequires:  pkgconfig(wpe-webkit-2.0) >= 2.50.0
...
%{_libdir}/girepository-%{majorminor}/GstHipGL-%{majorminor}.typelib
...
%{_libdir}/gstreamer-%{majorminor}/libgstmpeghdec.so
...
%{_datadir}/gir-%{majorminor}/GstHipGL-%{majorminor}.gir
...
%changelog
* Sun Sep 20 2026 Simone Caronni <negativo17@gmail.com> - 1:1.28.7-3
- Rebuild for updated dependencies.

* Fri Sep 18 2026 Simone Caronni <negativo17@gmail.com> - 1:1.28.7-2
...
* Fri May 22 2026 Simone Caronni <negativo17@gmail.com> - 1:1.28.3-2
- Rebuild for updated dependencies.
...
* Sun Nov 16 2025 Simone Caronni <negativo17@gmail.com> - 1:1.26.8-1
- Update to 1.26.8.
...
- nvcodec for aarch64 requires now the Jetson libraries, so it's disabled.
