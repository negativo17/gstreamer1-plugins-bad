...
Patch2:         https://gitlab.freedesktop.org/gstreamer/gst-plugins-bad/-/commit/67a84254aef632f5d765726939544dff014c14ea.diff
...
BuildRequires:  nvidia-sdk-video-codec >= 1:8.2.16
}
...
%build
autoreconf -vif
export CUDA_CFLAGS="-I%{_includedir}/cuda -I%{_includedir}/nvidia-sdk-video-codec"
export CUDA_LIBS="-L%{_libdir} -lcuda -lcudart"
export NVENCODE_CFLAGS="-I%{_includedir}/nvidia-sdk-video-codec"
...
%changelog
* Mon Jun 17 2024 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-12
- Rebuild for updated dependencies.

* Sun Jun 04 2023 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-11
- Rebuild for updated dependencies.

* Wed Mar 15 2023 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-10
- Rebuild for updated dependencies.

* Fri Jan 06 2023 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-9
- Rebuild for updated dependencies.

* Thu Sep 22 2022 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-8
- Rebuild for updated dependencies.

* Sat Mar 19 2022 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-7
- Rebuild for updated dependencies.

* Wed Sep 22 2021 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-6
- Rebuild for updated dependencies.

* Tue Jul 20 2021 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-5
- Rebuild for updated dependencies.

* Sun Jun 20 2021 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-4
- Rebuild for updated dependencies.

* Fri Mar 26 2021 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-3
- Enable DTS plugin.

* Tue Dec 08 2020 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-2
- Rebuild for updated CUDA.

* Mon Jul 13 2020 Simone Caronni <negativo17@gmail.com> - 1:1.14.5-1
- Update to 1.14.5.

* Mon Jun 29 2020 Simone Caronni <negativo17@gmail.com> - 1:1.14.4-6
- Rebuild for updated dependencies.
